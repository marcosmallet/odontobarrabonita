  ...
  expect(capturedEvents).toEqual([
    [
      ...
      "whatsapp_click",
      {
        ...
        dentist_id: "carlos",
        lead_source: "direct",
        page_path: "/dentista-no-recreio/",
        page_title: "Dentista no Recreio dos Bandeirantes | Clínica Barra Bonita",
        service: "geral",
        service_name: "geral",
      },
    ],
    [
      ...
      "phone_click",
      {
        cta_location: "professional",
        cta_text: "Ligar para Dr. Carlos",
        cta_type: "phone",
        dentist: "carlos",
        dentist_id: "carlos",
        lead_source: "direct",
