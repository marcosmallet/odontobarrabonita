...
const pages = [
  ...
  { id: "toxina", serviceName: "toxina", pagePath: "/toxina-botulinica-no-recreio/", title: "Toxina Botulínica no Recreio | Clínica Barra Bonita", h1: "Toxina Botulínica no Recreio dos Bandeirantes", description: "Toxina botulínica no Recreio dos Bandeirantes com avaliação individual para linhas de expressão e equilíbrio facial na Clínica Barra Bonita.", professionalId: "francisco", related: [{ href: "/harmonizacao-orofacial-no-recreio/", label: "Conhecer harmonização orofacial" }, { href: "/dentista-no-recreio/", label: "Conhecer a clínica e os profissionais" }] },
] as const;
